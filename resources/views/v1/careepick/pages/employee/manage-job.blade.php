                ...
                <div class="col-md-3 col-sm-5">
                    ...
                    <div class="widget-boxed padd-bot-0">
                        <div class="widget-boxed-header br-0">
                            <h4>Designation <a href="#designation" data-toggle="collapse"><i class="pull-right ti-plus"
                    ...
                    <div class="widget-boxed padd-bot-0">
                        <div class="widget-boxed-header br-0">
                            <h4>Experince <a href="#experince" data-toggle="collapse"><i class="pull-right ti-plus"
                                        aria-hidden="true"></i></a></h4>
                        </div>
                    ...
                    <div class="widget-boxed padd-bot-0">
                        <div class="widget-boxed-header br-0">
                            <h4>Qualification <a href="#qualification" data-toggle="collapse"><i
                                        class="pull-right ti-plus" aria-hidden="true"></i></a></h4>
                        </div>
                ...
                <div class="col-md-9 col-sm-7">
                    ...
                    <div class="job-verticle-list">
                        <div class="vertical-job-card">
                            <div class="vertical-job-header">
                                <div class="vrt-job-cmp-logo"> <a href="job-detail.html"><img
                                            src="{{ URL::asset('assets/img/company_logo_1.png') }}" class="img-responsive"
                                            alt="" /></a> </div>
                                <h4><a href="job-detail.html">Apple LTD</a></h4>
                                <span class="com-tagline">Software Development</span> <span
                                    class="pull-right vacancy-no">No. <span class="v-count">2</span></span>
                            </div>
                                ...
                                <div class="row">
                                        ...
                                        <ul class="can-skils">
                                            ...
                                            <li><strong>Skills: </strong>
                                                <div><span class="skill-tag">HTML</span> <span
                                                        class="skill-tag">css</span> <span class="skill-tag">java</span>
                                    ...
                                    <div class="col-md-3 col-sm-12 col-xs-12">
                                        <div class="vrt-job-act"> <a href="#" data-toggle="modal"
                                            ...
                                            <a href="job-detail.html" title="" class="btn-job light-gray-btn">View
                                                Job</a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="job-verticle-list">
                        <div class="vertical-job-card">
                            <div class="vertical-job-header">
                                <div class="vrt-job-cmp-logo"> <a href="job-detail.html"><img
                                            src="{{ URL::asset('assets/img/company_logo_2.png') }}" class="img-responsive"
                                            alt="" /></a> </div>
                    ...
                    <div class="job-verticle-list">
                        <div class="vertical-job-card">
                            <div class="vertical-job-header">
                                <div class="vrt-job-cmp-logo"> <a href="job-detail.html"><img
                                            src="{{ URL::asset('assets/img/company_logo_3.png') }}" class="img-responsive"
                                            alt="" /></a> </div>
                                <h4><a href="job-detail.html">Laxol LTD</a></h4>
                                <span class="com-tagline">Frond End Designer</span> <span
                                    class="pull-right vacancy-no">No. <span class="v-count">2</span></span>
                            </div>
                            <div class="vertical-job-body">
                                <div class="row">
                    ...
                    <div class="job-verticle-list">
                        <div class="vertical-job-card">
                            <div class="vertical-job-header">
                                <div class="vrt-job-cmp-logo"> <a href="job-detail.html"><img
                                            src="{{ URL::asset('assets/img/company_logo_4.png') }}" class="img-responsive"
                                            alt="" /></a> </div>
                                <h4><a href="job-detail.html">Sirix LTD</a></h4>
                                <span class="com-tagline">CMS Development</span> <span class="pull-right vacancy-no">No.
                                    <span class="v-count">2</span></span>
                            </div>
                            <div class="vertical-job-body">
                                <div class="row">
                                    <div class="col-md-9 col-sm-12 col-xs-12">
                    ...
                    <div class="job-verticle-list">
                        <div class="vertical-job-card">
                            <div class="vertical-job-header">
                                <div class="vrt-job-cmp-logo"> <a href="job-detail.html"><img
                                            src="{{ URL::asset('assets/img/company_logo_5.png') }}" class="img-responsive"
                                            alt="" /></a> </div>
                                <h4><a href="job-detail.html">Indico LTD</a></h4>
                                <span class="com-tagline">PHP Development</span> <span class="pull-right vacancy-no">No.
                                    <span class="v-count">2</span></span>
                            </div>
                            <div class="vertical-job-body">
                                <div class="row">
